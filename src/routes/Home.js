    ...
    <IonPage>
      ...
      <IonContent>
        <section style={{ padding: '10px' }}>
          ...
          <p>
            During the course you will build a real fully responsive Daily
            Agenda application.
          </p>
          <div className='text-center'>
            {' '}
          ...
          <section className='text-center'>
            <div className='row features-big mt-5'>
              <div className='col-md-3 mb-r'>
                ...
                <p>
                  The newest version of React including the most recent
                  features. The technology used by Facebook, Airbnb, Amazon, and
                  American Express.
                </p>
              </div>
              ...
              <div className='col-md-3 mb-r'>
                ...
                <p>
                  JSX is a syntax extension to JavaScript. JSX may remind you of
                  a template language, but it comes with the full power of
                  JavaScript.
                </p>
              </div>
            ...
            <div className='row features-big'>
              ...
              <div className='col-md-3 mb-r'>
                ...
                <p>
                  ...
                  should continue reading. This tutorial will guide you on how
                  to build a Single Page Application, which works without
                  reloading.
                </p>
              </div>
              ...
              <div className='col-md-3 mb-r'>
                ...
                <p>
                  ...
                  Development - in other words, how to build a website which
                  looks awesome on each device. Regardless of whether it's a
                  30-inch monitor or a smartphone screen.
                </p>
              </div>
              ...
              <div className='col-md-3 mb-r'>
                ...
                <p>
                  ...
                  tools - Bootstrap and Material Design to achieve an
                  outstanding effect on your website for application.
                </p>
              </div>
            </div>
          </section>
